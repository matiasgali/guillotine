...
(function() {
  ...
  canTransform = function() {
    var hasTransform, helper, i, len, prefix, prefixes, prop, test, tests, value;
    hasTransform = false;
  ...
  Guillotine = (function() {
    function Guillotine(element, options) {
      ...
      this.data = {
        ...
        h: this.op.height,
        minScale: 1,
        zoomStep: +this.op.zoomStep.toFixed(2),
        maxScale: +this.op.maxScale.toFixed(2)
      };
      this._wrap(element);
    ...
    Guillotine.prototype._wrap = function(element) {
      ...
      this.data.minScale = +(Math.max.apply(this, [this.op.width / this.widthReal, this.op.height / this.heightReal])).toFixed(2);
    ...
    Guillotine.prototype._zoom = function(factor) {
      ...
      w = this.width;
      h = this.height;
      if (this.op.maxScale && this.data.scale * factor > this.op.maxScale) {
        return;
      }
    ...
    Guillotine.prototype._zoomScale = function(scale) {
      var factor;
      scale = parseFloat(scale);
      factor = scale / this.data.scale;
      return this._zoom(factor);
    };
    ...
    Guillotine.prototype._rotate = function(angle) {
      var canvasRatio, glltRatio, h, ref, ref1, ref2, ref3, w;
      if (!canTransform()) {
        return;
      }
      ...
      if (angle % 180 !== 0) {
        ...
        h = this.heightReal;
        if (this.angle % 180 !== 0) {
          ref = [h, w], w = ref[0], h = ref[1];
        }
        this.data.minScale = +(Math.max.apply(this, [this.op.width / w, this.op.height / h])).toFixed(2);
        glltRatio = this.op.height / this.op.width;
        ref1 = [this.height * glltRatio, this.width / glltRatio], this.width = ref1[0], this.height = ref1[1];
        if (this.width >= 1 && this.height >= 1) {
      ...
      ref2 = [1, 1], w = ref2[0], h = ref2[1];
      if (this.angle % 180 !== 0) {
        canvasRatio = this.height / this.width * glltRatio;
        ref3 = [canvasRatio, 1 / canvasRatio], w = ref3[0], h = ref3[1];
      }
    ...
    Guillotine.prototype.zoomCustom = function(f) {
      return this.enabled && (this._zoomScale(f), this._trigger('zoomCustom'));
    };
  ...
  whitelist = ['rotateLeft', 'rotateRight', 'center', 'fit', 'zoomIn', 'zoomOut', 'zoomCustom', 'instance', 'getData', 'enable', 'disable', 'remove'];
  ...
  $.fn[pluginName] = function(options, param) {
    if (typeof options !== 'string') {
    ...
    } else if (indexOf.call(whitelist, options) >= 0) {
      if (options === 'instance') {
      ...
      return this.each(function() {
        ...
        if (guillotine) {
          return guillotine[options](param);
        }
      });
    }
  };
